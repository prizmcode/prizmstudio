<?php get_header(); ?>
    ...
    ?>
        ...
        <div class="entry-header mb-4 relative z-30 flex flex-col justify-end md:bg-scroll bg-cover bg-no-repeat bg-center" style="background-image: url(<?php echo $thumb; ?>);">
