<?php get_header(); ?>
    ...
    ?>
        ...
        <div class="entry-header mb-4 relative z-30 flex flex-col justify-end md:bg-scroll lg:bg-fixed bg-cover bg-no-repeat bg-center h-screen" style="background-image: url(<?php echo $thumb; ?>);">
